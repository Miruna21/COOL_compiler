...
public class Compiler {
    ...
    public static void main(String[] args) throws IOException {
        ...
        /* Print tree
        var printVisitor = new ASTBaseVisitor();
        ...
        */
        ...
        // Semantic analysis
        var classHierarchyConstruction = new ClassHierarchyConstruction();
        classHierarchyConstruction.visit((Program) ast);

        if (classHierarchyConstruction.checkHierarchy((Program) ast)) {
        ...
        var st = ast.accept(codeGenVisitor);
